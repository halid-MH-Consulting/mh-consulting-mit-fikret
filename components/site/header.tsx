...
export function Header() {
  ...
  // Kompakter Zustand, sobald der Hero verlassen wird.
  useEffect(() => {
  ...
  // Aktiven Abschnitt markieren, damit man beim Scrollen weiss, wo man ist.
  useEffect(() => {
    ...
    >
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-6 px-6 md:h-20">
        <a
          ...
          aria-label="MH Consulting — back to top"
        >
      ...
      {open && (
        <div
          id="mobile-nav"
          ref={panelRef}
          // Bildschirmfuellend statt als Klappe: sonst scheint der Hero
